                    ...
                    <div className="flex flex-col gap-5 w-full md:w-[70%]">
                        {
                            ...
                            <section key={product.id} className="flex gap-2 rounded-md p-2 border-2 border-gray-200 shadow-md hover:scale-101 duration-500">
                                ...
                                <div className="flex flex-col gap-5 items-center justify-center w-[25%] border-l-2 border-gray-200">
                                    ...
                                    <button className="bg-teal-500 p-2 font-bold text-sm rounded-md text-white cursor-pointer hover:bg-teal-600 duration-500" onClick={() => removeFromCart(product.id)}><Trash2Icon className="text-white h-4" /></button>
                                </div>
                            </section>
                        )}
                    </div>
